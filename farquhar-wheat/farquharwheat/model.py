...
def calculate_photosynthesis(PAR, surfacic_nitrogen, NSC_Retroinhibition, surfacic_NSC, Ts, Ci):
    ...
    :param float surfacic_nitrogen: surfacic nitrogen content(g m-2) including or not structural nitrogen depending on parameter.MODEL_VERSION, zhao: the default surfacic_nitrogen is 2
    ...
    :param float Ci: internal CO2 (µmol mol-1), Ci = 0.7*CO2 air for the first iteration
    ...
    Gamma = _f_temperature('Gamma', parameters.GAMMA25, Ts) # GAMMA25 is the CO2 compensation point.

    #: RuBisCO-limited carboxylation rate
    Sna_Vcmax25 = parameters.PARAM_N['S_surfacic_nitrogen']['Vc_max25'] # ratio between Vc_max25 and surfacic_nitrogen

    ...
    if run_simu:
        ...
        try:
            for t_caribu in range(START_TIME, SIMULATION_LENGTH, SENESCWHEAT_TIMESTEP):
                ...
                # caribu_facade_.run(run_caribu, energy=PARi, DOY=DOY, hourTU=hour, latitude=36.23, sun_sky_option='sky', heterogeneous_canopy=heterogeneous_canopy, plant_density=PLANT_DENSITY[1], inter_row=INTER_ROW)
...
if __name__ == '__main__':
    main(simulation_length=2000, forced_start_time=0,
         run_simu=True, run_postprocessing=False, generate_graphs=False, run_from_outputs=False,
         show_3Dplant=False, heterogeneous_canopy=True, METEO_FILENAME="meteo_PAR1500.csv")

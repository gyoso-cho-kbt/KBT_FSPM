...
# def insert_base_top_element(g):        # new version but not adopt
    # ele_level = 5
...
def main(stop_time, run_simu=True, make_graphs=True):
    if run_simu:
        ...
        # zhao memo: the parameters {roots:'K_AMINO_ACIDS_SUCROSE'} and {PhotosyntheticOrgan:'SIGMA_SUCROSE'} are in order to raise the C/N ratio in grain. 
        update_cnwheat_parameters = {'roots': {'K_AMINO_ACIDS_EXPORT': 25*3E-5,
                                               'K_NITRATE_EXPORT': 25*1E-6,
                                               'K_AMINO_ACIDS_SUCROSE': 350000,
                                               }, 

...
class CNWheatFacade(object):
    ...
    def _initialize_model(self, Tair=12, Tsoil=12, tillers_replications=None):
            ...
            for mtg_axis_vid in self._shared_mtg.components_iter(mtg_plant_vid):
                ...
                for mtg_metamer_vid in self._shared_mtg.components_iter(mtg_axis_vid):
                    ...
                    for mtg_organ_vid in self._shared_mtg.components_iter(mtg_metamer_vid):
                        ...
                        if mtg_organ_label not in MTG_TO_CNWHEAT_PHYTOMERS_ORGANS_MAPPING or self._shared_mtg.get_vertex_property(mtg_organ_vid)['length'] == 0: # zhao: skip the 0-length organ.
                            continue
                        ...
                        for mtg_element_vid in self._shared_mtg.components_iter(mtg_organ_vid):
                            ...
                            for cnwheat_element_data_name in cnwheat_simulation.Simulation.ELEMENTS_STATE: # zhao: set the calculated element-level results from other module, e.g. Ag, An, etc.
                            ...
                            # Add the parameters from organ scale
        ...
        self._simulation.initialize(self.population, self.soils, Tair=Tair, Tsoil=Tsoil) # reset population and soil variables in simulation class. Reconstruct the initial_conditions and initial_conditions_mapping

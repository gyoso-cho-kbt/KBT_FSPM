...
class SenescWheatFacade(object):
    ...
    def _update_shared_MTG(self, senescwheat_roots_data_dict, senescwheat_axes_data_dict, senescwheat_elements_data_dict, option_static=False):
        """
        ...
        if option_static: # added by zhao: only update MTG when not static
            return

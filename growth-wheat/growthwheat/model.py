...
def calculate_ratio_mstruct_DM(mstruct, sucrose, fructans, amino_acids, proteins):
    ...
    dry_mass = ((sucrose * 1E-6 * C_MOLAR_MASS) / parameters.HEXOSE_MOLAR_MASS_C_RATIO +  # the ratio of sucrose is the same as the HEXOSE
                ...
                (proteins * 1E-6 * N_MOLAR_MASS) / parameters.PROTEINS_MOLAR_MASS_N_RATIO +   # modified by zhao. From 'parameters.AMINO_ACIDS_MOLAR_MASS_N_RATIO' to 'parameters.PROTEINS_MOLAR_MASS_N_RATIO'
                mstruct)

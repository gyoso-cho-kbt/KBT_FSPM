...
class PhotosyntheticOrganElementParameters(object):  # zhao's remark: although the default element parameters is None, in run time the paramters will be derivated from the organ class. Refer to cnwheat_facade.py L359
    """
